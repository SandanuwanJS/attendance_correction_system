...
<head>
		...
		<!-- Title -->
		<title>Raigam Attendance System | Dashboard</title>
			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2 mb-xl-0">Dashboard </h4>
						</div>
						...
						<div class="row row-sm">
							<div class="col-xl-6 col-xxl-3 col-sm-12 col-lg-6 col-md-6">
								<div class="card  widgets-cards bg-danger-gradient shadow-danger text-default border-0">
									<div class="card-body">
										<div class="d-flex">
										<div class="chart-circle chart-circle-sm me-1" data-value="0.62" data-thickness="6" data-color="#b50d05"><canvas width="64" height="64"></canvas><div class="chart-circle-value text-white">70%</div></div>
										<div class="ms-2 mt-2">
												<h2 class="mb-0 tx-22">Orders</h2>
												<div class="">
							...
							<div class="col-xl-6 col-xxl-3 col-sm-12 col-lg-6 col-md-6">
								<div class="card  widgets-cards bg-success-gradient shadow-success text-default border-0">
									<div class="card-body">
										<div class="d-flex">
										<div class="chart-circle chart-circle-sm me-1" data-value="0.62" data-thickness="6" data-color="#2b9146"><canvas width="64" height="64"></canvas><div class="chart-circle-value text-white">70%</div></div>
										<div class="ms-2 mt-2">
												<h2 class="mb-0 tx-22">Views</h2>
												<div class="">
							...
							<div class="col-xl-6 col-xxl-3 col-sm-12 col-lg-6 col-md-6">
								<div class="card  widgets-cards bg-secondary-gradient shadow-secondary text-default border-0">
									<div class="card-body">
										<div class="d-flex">
										<div class="chart-circle chart-circle-sm me-1" data-value="0.62" data-thickness="6" data-color="#dd4829"><canvas width="64" height="64"></canvas><div class="chart-circle-value text-white">70%</div></div>
										<div class="ms-2 mt-2">
												<h2 class="mb-0 tx-22">Earnings</h2>
												<div class="">
													<span class="tx-12"><i class="fe fe-arrow-up-right"></i></span>
							...
							<div class="col-xl-6 col-xxl-3 col-sm-12 col-lg-6 col-md-6">
								<div class="card  widgets-cards bg-info-gradient shadow-info text-default border-0">
									<div class="card-body">
										<div class="d-flex">
										<div class="chart-circle chart-circle-sm me-1" data-value="0.20" data-thickness="6" data-color="#3578d5"><canvas width="64" height="64"></canvas><div class="chart-circle-value text-white">70%</div></div>
										<div class="ms-2 mt-2">
												<h2 class="mb-0 tx-22">Comments</h2>
												<div class="">
													<span class="tx-12"><i class="fe fe-arrow-down-right"></i></span>
													<span class="tx-12">-55.29%</span>
												</div>
											</div>
											<h2 class="mt-3 ms-auto">8758</h2>
										</div>
