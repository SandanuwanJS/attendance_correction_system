...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <!-- Title -->
        <title>Raigam Attendance System | Delete Employee</title>
            ...
            <div class="main-content app-content">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="breadcrumb-header justify-content-between">
                        <div>
                            <h4 class="content-title mb-2 mb-xl-0">Delete Employees</h4>
                        </div>
                        <div class="d-flex my-auto">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= base_url('') ?>Home/index">Home</a></li>
                                    <li class="breadcrumb-item active " aria-current="page">Delete Employees</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <p class="mg-b-20 text-muted tx-13 mb-0">Delete Employees From The System</p>
                                                                ...
                                                                <?php if (isset($userRecords) && !empty($userRecords)) { ?>
                                                                    <?php foreach ($userRecords as $user) { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><a href="<?= base_url('DeleteEmployee/delete_employee/' . $user['person_id']) ?>" 
                                                                            class="btn btn-danger" 
                                                                            onclick="return confirm('Are you sure you want to delete \n Person ID: <?php echo $user['person_id'] ?> \n Name: <?php echo $user['name_in_finger'] ?>? ');">
                                                                            Delete</a></td>
