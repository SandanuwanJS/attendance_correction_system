...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <!-- Title -->
        <title>Raigam Attendance System | Register Employee</title>
    ...
    <body class="main-body app sidebar-mini ltr">
            ...
            <div class="main-content app-content">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="breadcrumb-header justify-content-between">
                        <div>
                            <h4 class="content-title mb-2 mb-xl-0">Employee Registration</h4>
                        </div>
                        <div class="d-flex my-auto">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= base_url('') ?>Home/index">Home</a></li>
                                    <li class="breadcrumb-item active " aria-current="page">Register Employees</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <p class="mg-b-20 text-muted tx-13 mb-0">Add employees to the system</p>
                                        <a href="<?= base_url('') ?>EmployeeRegister/employeeViewList" class="btn btn-info  btn-rounded " style="float: right">View List</a>
                                        <div class="card-title">Register Employees</div>

                                    </div>
                                    <form method="POST" action="<?= base_url('') ?>EmployeeRegister/registerEmployee" id="em_registerForm">
                                        <div class="card-body">
                                            <?php
                                            ...
                                            <div class="row row-sm"> 
                                                <div class="col-lg">
                                                    <lable class="" > Person ID </lable>
                                                    <span class="" id="pidError" style="color: red">*</span>
                                                    <input class="form-control" placeholder="Person ID" name="pid" id="pid" type="text">
                                                </div>

                                                <div class="col-lg">
                                                    <span class="">Name with Initial</span>
                                                    <input class="form-control" placeholder="Name with Initial" name="nameI" id="nameI" type="text">
                                                </div>

                                                <div class="col-lg mg-t-10 mg-lg-t-0">
                                                    <lable class="">Name in the Fingerprint machine</lable>
                                                    <span class="" id="nameError" style="color: red">*</span>
                                                    <input class="form-control" placeholder="Name in the Fingerprint machine" name="nameinfinger" id="nameinfinger" type="text">
                                                </div>

                                                <div class="col-lg mg-t-10 mg-lg-t-0">
                                                    <span class="">NIC Num</span>
                                                    <input class="form-control" placeholder="NIC Num" name="nic" id="nic" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row row-sm mg-t-20">
                                                <div class="col-lg mg-t-10 mg-lg-t-0">
                                                    <lable class="">Telephone Number</lable>
                                                    <span class="" id="teleError" style="color: red">*</span>
                                                    <input class="form-control" placeholder="(07x) xxx xxxx" name="telenum" id="telenum" type="tel"> 
                                                </div>

                                                <div class="col-lg mg-t-10 mg-lg-t-0">
                                                    <lable class="">Gender</lable>
                                                    <span class="" id="genderError" style="color: red">*</span>
                                                    <div class="form-check ">
                                                        <input class="form-check-input" name="gender" id="male" value="male" type="radio">
                                                        <lable class="form-check-lable" for="male"> Male </lable>
                                                    </div>
                                                    <div class="form-check "> 
                                                        <input class="form-check-input" name="gender" id="female" value="female" type="radio">
                                                        <lable class="form-check-lable" for="female"> Female </lable>
                                                    </div>
                                                </div>

                                                <div class="col-lg mg-t-10 mg-lg-t-0">
                                                    <ul class="sidemenu-list">
                                                        <lable for = "title"> <h7> Select Department </h7> </lable>
                                                        <span class="" id="departmentError" style="color: red">*</span>
                                                        <select name="mainDepartments" class="slide-item" id="mainDepartments"> 
                                                            <option value= ""> Select Department    </option>

                                                            <!-- ******************** Get department names from the table ******************** -->
                                                            <?php
                                                            $getdep = mysqli_query($con, "SELECT department_id, department_name FROM main_departments");
                                                            while ($resdep = mysqli_fetch_array($getdep)) { 
                                                            
                                                            ?>
                                                                <option value= "<?php echo $resdep['department_name'] ?>" > 
                                                                    <?php echo $resdep['department_name'] ?> 
                                                                </option>
                                                            <?php
                                                            }
                                                            ?>
                                                ...
                                                <div class="col-lg mg-t-10 mg-lg-t-0">
                                                    <ul class="sidemenu-list"> 
                                                        <lable for = "title"> <h7> Select ManPower Company </h7> </lable>
                                                        <span class="" id="MPError" style="color: red">*</span>
                                                        <select name="manpower" class="slide-item" id="manpower"> 
                                                            <option value="" > Select M Company  </option>

                                                            <!-- ******************** Get Manpower Company names from the table ******************** -->
                                                            <?php 
                                                            $getMP = mysqli_query($con, "SELECT manpower_id,company_name FROM manpower");
                                                            while ($resMP = mysqli_fetch_array($getMP)) {

                                                            ?>
                                                                <option value= "<?php echo $resMP['company_name'] ?>"> 
                                                                    <?php echo $resMP['company_name'] ?> 
                                                                </option>
                                                            <?php 
                                                            }
                                                            ?>
                                            ...
                                            <!-- ******************** Create button to cancle the registation form submitting ******************** -->
                                            <div class="row row-sm mg-t-20">
                                                <div class="col-lg mg-t-12 mg-lg-t-0" >
                                                    <a href="<?= base_url('') ?>EmployeeRegister/linkIndex" class="btn btn-danger  btn-rounded ">Cancel</a>
                                                </div>
                                                <div class="col-lg mg-t-12 mg-lg-t-0" >
        ...
        <script src="<?= base_url('') ?>application/views/js/employeeRegister.js"></script>
