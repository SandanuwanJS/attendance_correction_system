...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <!-- Title -->
        <title>Raigam Attendance System | Change Employee Status</title>
            ...
            <div class="main-content app-content">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="breadcrumb-header justify-content-between">
                        <div>
                            <h4 class="content-title mb-2 mb-xl-0">Employee Status</h4>
                        </div>
                        <div class="d-flex my-auto">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= base_url('') ?>Home/index">Home</a></li>
                                    <li class="breadcrumb-item active " aria-current="page">Change Employee Status</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <p class="mg-b-20 text-muted tx-13 mb-0">Change Employee Status</p>
                                        <div class="card-title">Employee View List</div>
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table id="delete-datatable" class="border-top-0 table table-bordered text-nowrap border-bottom">
                                                            <thead>
                                                                <tr>
                                                                    <th class="border-bottom-0">Person ID</th>
                                                                    <th class="border-bottom-0">Name</th>
                                                                    <th class="border-bottom-0">Gender</th>
                                                                    <th class="border-bottom-0">Department</th>
                                                                    <th class="border-bottom-0">Manpower Company</th>
                                                                ...
                                                                <?php if (isset($userRecords) && !empty($userRecords)) { ?>
                                                                    <?php foreach ($userRecords as $user) { ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo $user['name_in_finger']; ?></td>
                                                                            <td><?php echo $user['gender']; ?></td>
                                                                            <td><?php echo $user['department']; ?></td>
                                                                            <td><?php echo $user['manpower_company']; ?></td>
                                                                            <td><?php echo $user['date']; ?></td>
                                                                            <?php
                                                                                if ($user['isact'] == 1) {
                                                                                    ?>
                                                                                    <td><a href="<?= base_url('') ?>EmpStatusChange/activate/<?php echo $user['person_id'] ?>/<?php echo $user['isact'] ?>" class="btn btn-secondary">Disable</a></td>

                                                                                    <?php
                                                                                } else {
                                                                                    ?>
                                                                                    <td><a href="<?= base_url('') ?>EmpStatusChange/activate/<?php echo $user['person_id'] ?>/<?php echo $user['isact'] ?>" class="btn btn-info">Active</a></td>
