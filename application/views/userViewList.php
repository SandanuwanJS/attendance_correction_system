...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <!-- Title -->
        <title>Raigam Attendance System | User List</title>
            ...
            <div class="main-content app-content">
                ...
                <div class="main-container container-fluid">
                    ...
                    <div class="breadcrumb-header justify-content-between">
                        <div>
                            <h4 class="content-title mb-2 mb-xl-0">User Status</h4>
                        </div>
                        <div class="d-flex my-auto">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= base_url('') ?>Home/index">Home</a></li>
                                    <li class="breadcrumb-item active " aria-current="page">Change User Status</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <p class="mg-b-20 text-muted tx-13 mb-0">Change User Status</p>
                                        <a href="<?= base_url('') ?>user/linkIndex" class="btn btn-info  btn-rounded " style="float: right">Add New</a>
                                        <div class="card-title">User View List</div>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                foreach ($userRecords as $user) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        if ($user['isact'] == 1) {
                                                                            ?>
                                                                            <td><a href="<?= base_url('') ?>user/activate/<?php echo $user['id'] ?>/<?php echo $user['isact'] ?>" class="btn btn-secondary">Disable</a></td>

                                                                            <?php
                                                                        } else {
                                                                            ?>
                                                                            <td><a href="<?= base_url('') ?>user/activate/<?php echo $user['id'] ?>/<?php echo $user['isact'] ?>" class="btn btn-info">Active</a></td>
